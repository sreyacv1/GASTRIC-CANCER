...
3. **Benchmark (`30_`)** — a previously published 5-gene gastric signature, same data,
   same pipeline: C_apparent 0.5446, **C_optimism_corrected 0.4807 (R 4.3.3/`rms` 6.8-1, archived as `sessionInfo_rms6.8-1_R4.3.3.txt`; re-running under `rms` 8.1-1 gives 0.52 — both chance-level, apparent C 0.54 unchanged) (chance-level)**.
